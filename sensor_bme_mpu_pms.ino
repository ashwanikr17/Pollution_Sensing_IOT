...
SoftwareSerial Serial12(12,11); // serial ports RX, TX
...
void setup()
{
  ...
  Serial12.begin(9600);
    ...
    Serial12.println("Sensor port ready");
  ...
  Serial12.begin(9600);
    ...
    while (Serial12.read()!=-1) {};  //clear buffer
    Serial12.println("PMS Sensor port ready");
}

bool pms7003ReadData() {
//    Serial12.println("Reading data!");
...
//      delay(100);
    ...
    if (Serial12.read() != 0x42) return 0;// uno- ttyACM0 nano-ttyUSB0 PROMINI-ttyUSB1
...
//  Serial.println("O");
  Serial.println(millis()-tlast);
  Serial.print("BME-");
  printBME280Data(&Serial);
  Serial.print('\n');
  int readv = pms7003ReadData();
...
#define SWAP(x,y) swap = x; x = y; y = swap
  ...
  // AX, AY, AZ are from accelerometer and GX, GY, GZ are from Gyrometer
...
)
{
   ...
   client->print("T:");             //temperature
   client->print(temp);
   //client->print("°"+ String(tempUnit == BME280::TempUnit_Celsius ? 'C' :'F'));
   client->print("H:");           //humidity
   client->print(hum);
   //client->print("% RH");
